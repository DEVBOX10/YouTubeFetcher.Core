...
namespace YouTubeFetcher.Core.Tests.Factories
{
    ...
    {
        private readonly IDecryptorServiceFactory _decryptorServiceFactory;

        public DecryptorServiceFactoryTests()
        {
            _decryptorServiceFactory = new DecryptorServiceFactory();
        }
