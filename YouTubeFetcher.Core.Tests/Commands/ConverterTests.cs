...
namespace YouTubeFetcher.Core.Tests.Commands
{
    ...
    {
        private readonly IConverterCommand _reverse;
        private readonly IConverterCommand _slice;
        private readonly IConverterCommand _swap;

        public ConverterTests()
        {
            _reverse = new ReverseConverterCommand();
            _slice = new SliceConverterCommand();
            _swap = new SwapConverterCommand();
        }
